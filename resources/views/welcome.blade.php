        ...
        <div class="d-flex align-items-center justify-content-center" style="height: 80vh;">
            <div class="card text-center shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="width: 80vw;">
                <div class="mt-3 text-center">
                    <p class="display-3 fw-bold">DIGITAL REPORTING PRODUCTION</p>
                    <img src="{{ asset('img/logo-sat.jpg') }}" class="rounded mx-auto d-block my-3" alt="{{ asset('img/logo-sat.jpg') }}" style="width: 15rem;">
                    <p class="display-5">CV. SINAR AGUNG TEKNIK </p>
                </div>
            </div>
        </div>
